...
__all__ = [
    ...
    "simple_firing_rates", "simple_spike_counts", "create_simple_plot",
    "intermediate_isi_cv", "intermediate_fano_factor", "create_intermediate_plot",
    "advanced_burst_detection", "advanced_synaptic_plasticity_trends",
    "advanced_neuromodulator_correlation", "advanced_spike_entropy", "create_advanced_plot",
    "run_all_analytics",
