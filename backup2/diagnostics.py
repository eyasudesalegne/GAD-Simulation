...
def set_simulation_parameters(sim, severity):
    ...
    if hasattr(sim, 'neuromodulators'):
        ...
        baseline_da = sim._baseline_parameters.get('DA', 0.2)
        baseline_5ht = sim._baseline_parameters.get('5-HT', 0.2)
        baseline_ne = sim._baseline_parameters.get('NE', 0.2)
        baseline_ach = sim._baseline_parameters.get('ACh', 0.2)
        baseline_cort = sim._baseline_parameters.get('Cort', 0.2)
